      ...
      <div class="Nav">
        ...
        <div class="nav swiper-container" ref="nav" @click="switchNav">
          <ul class="navWrap swiper-wrapper">
            <li class="navItem swiper-slide"><span class="on">首页</span></li>
            <li class="navItem swiper-slide"><span>狗狗主粮</span></li>
            <li class="navItem swiper-slide"><span>服饰城</span></li>
            <li class="navItem swiper-slide"><span>医疗保健</span></li>
            <li class="navItem swiper-slide"><span>零食玩具</span></li>
            <li class="navItem swiper-slide"><span>日用外出</span></li>
            <li class="navItem swiper-slide"><span>美容香波</span></li>
          </ul>
        </div>
        <div class="mao">
          <div class="maoIn">
    ...
    <div class="container" :class="{on:!showHead}" >
        ...
        <div class="banner swiper-container">
          <ul class="bannerWrap swiper-wrapper">
            <a href="javascript:;" class="bannerItem swiper-slide" ><img src="./img/01.jpg" alt=""></a>
            <a href="javascript:;" class="bannerItem swiper-slide" ><img src="./img/02.jpg" alt=""></a>
            <a href="javascript:;" class="bannerItem swiper-slide" ><img src="./img/03.jpg" alt=""></a>
            <a href="javascript:;" class="bannerItem swiper-slide" ><img src="./img/04.jpg" alt=""></a>
            <a href="javascript:;" class="bannerItem swiper-slide" ><img src="./img/05.jpg" alt=""></a>
          </ul>
          <div class="ban swiper-pagination" style="height: 20px"></div>
        </div>
        <div class="hotType">
          <ul class="hotTypeWrap">
            <a class="hotTypeItem" href="javascript:;"><img src="./img/06.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/07.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/08.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/09.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/10.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/11.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/12.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/13.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/14.jpg" alt=""></a>
            <a class="hotTypeItem" href="javascript:;"><img src="./img/15.jpg" alt=""></a>
          </ul>
        </div>
        <div class="ban">
