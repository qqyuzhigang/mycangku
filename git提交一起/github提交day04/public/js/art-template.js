...
!function (e, t) {
  ...
  return function (e) {
    ...
    var i = n(9), o = n(11), s = "$data", a = "$imports", c = "print", u = "include", p = "extend", l = "block",
      f = "$$out", h = "$$line", m = "$$blocks", d = "$$slice", v = "$$from", g = "$$options", y = function (e, t) {
        ...
        return e.prototype.getTplTokens = function () {
          ...
          var e = this.options, t = this.context, n = this.scripts, r = this.stacks, i = this.source, c = e.filename,
            l = e.imports, d = [], x = y(this.CONTEXT_MAP, p), w = 0, E = function (e, t) {
